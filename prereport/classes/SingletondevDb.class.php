...
//         private $_seaweb_archive_db_connection;
	...
	//private $_npi_data_database = "seaweb_npi_data_db";
       // private $_seaweb_buffer_database = "seaweb_buffer";
        ...
        // private $_seaweb_dashboard_database = "seaweb_dashboard_db";
           private $_seaweb_archive_database = "seaweb_pv_archive_db";
...
//                 
               $this->_seaweb_archive_db_connection = new mysqli($this->_host, $this->_username, 
 			$this->_password, $this->_seaweb_archive_database);
//	 
//                if ($this->_npi_data_db_connection->connect_errno) {
//                printf("Connect failed: %s\n", $this->_npi_data_db_connection->connect_error); 
//                }
//                 if ($this->_seaweb_buffer_db_connection->connect_errno) {
//                printf("Connect failed: %s\n", $this->_seaweb_buffer_db_connection->connect_error); 
//                }
 //               if ($this->_seaweb_primevera_db_connection->connect_errno) {
  //              printf("Connect failed: %s\n", $this->_seaweb_primevera_db_connection->connect_error); 
   //             }
//                 if ($this->_seaweb_dashboard_db_connection->connect_errno) {
//                printf("Connect failed: %s\n", $this->_seaweb_dashboard_db_connection->connect_error); 
//                }
                if ($this->_seaweb_archive_db_connection->connect_errno) {
                 printf("Connect failed: %s\n", $this->_seaweb_archive_db_connection->connect_error); 
               }
	}
...
//	}
//        
          public function getSeawebArchiveDbConnection() {
		return $this->_seaweb_archive_db_connection;
	}
//       
