...
function showHideColumn(){
   var  isVisible =  $('#allNPIContentTable td:nth-child(3),th:nth-child(3),td:nth-child(4),th:nth-child(4),td:nth-child(5),th:nth-child(5),td:nth-child(6),th:nth-child(6),td:nth-child(7),th:nth-child(7)').is(":visible");
    if(isVisible){
         $('#allNPIContentTable td:nth-child(3),th:nth-child(3),td:nth-child(4),th:nth-child(4),td:nth-child(5),th:nth-child(5),td:nth-child(6),th:nth-child(6),td:nth-child(7),th:nth-child(7)').hide();
         $("#npiProjectHead").html("<a href='#'>More Details</a>");
    }else{
         $('#allNPIContentTable td:nth-child(3),th:nth-child(3),td:nth-child(4),th:nth-child(4),td:nth-child(5),th:nth-child(5),td:nth-child(6),th:nth-child(6),td:nth-child(7),th:nth-child(7)').show();
