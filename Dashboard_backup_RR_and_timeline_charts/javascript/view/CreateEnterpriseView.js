...
enterpriseCntnt += "<tr>";
enterpriseCntnt +="<td><a href='/pv/reports/OverBooked.php'><b>Resources Overbooked Report</b></a></td>";
enterpriseCntnt += "</tr>"; 
enterpriseCntnt += "</table>";
enterpriseCntnt +=  " <table class='table table-bordered allContentTable' id='allEnterpriseContentTable'>";
enterpriseCntnt += "<tr>";
enterpriseCntnt +="<td><strong>US</strong><br><a href='/pv/AMPG.php?option=GetRegion&div=AMPG&view=ROLE&Region=US%3A72245%2C98150%2C77297'><img src='http://webnpi.am.freescale.net/pv/img/ResChart.php?width=1000&hight=400&file=/proj/.web_webnpi/html/pv/img/static/US.csv'  border=2></a></td>";
enterpriseCntnt +="<td><strong>BRZ</strong><br><a href='/pv/AMPG.php?option=GetRegion&div=AMPG&view=ROLE&Region=BRZ%3A98151%2C77011%2C78005'><img src='http://webnpi.am.freescale.net/pv/img/ResChart.php?width=1000&hight=400&file=/proj/.web_webnpi/html/pv/img/static/BRZ.csv' border=2></a></td>";
enterpriseCntnt += "</tr>";
enterpriseCntnt += "<tr>";
enterpriseCntnt +="<td><strong>EMEA</strong><br><a href='/pv/AMPG.php?option=GetRegion&div=AMPG&view=ROLE&Region=EMEA%3A82435%2C82437%2C80473%2C72136%2C98145%2C80460%2C98147%2C81815%2C77009%2C72565#null'><img src='http://webnpi.am.freescale.net/pv/img/ResChart.php?width=1000&hight=400&file=/proj/.web_webnpi/html/pv/img/static/EMEA.csv' border=2></a></td>";
enterpriseCntnt +="<td><strong>IDC</strong><br><a href='/pv/AMPG.php?option=GetRegion&div=AMPG&view=ROLE&Region=IDC%3A80461%2C98149%2C72137%2C98146%2C97074%2C95705%2C83571%2C73690%2C82433%2C82127%2C75303%2C75763%2C77103#null'><img src='http://webnpi.am.freescale.net/pv/img/ResChart.php?width=1000&hight=400&file=/proj/.web_webnpi/html/pv/img/static/IDC.csv' border=2></a></td>";
enterpriseCntnt += "</tr>";
enterpriseCntnt += "</table>";
enterpriseCntnt +=  " <table class='table table-bordered allContentTable' id='allEnterpriseContentTable'>";
enterpriseCntnt += "<tr>";
enterpriseCntnt +="<td><strong>Milestone Metrics</strong><br><img src='http://webnpi.am.freescale.net/docs/TSPG/MCD/dashboard/img/Milestones.php'  border=2> </td>";
enterpriseCntnt +="<td><strong>Phase vs QMS</strong><br><img src='http://webnpi.am.freescale.net/docs/TSPG/MCD/dashboard/img/QMSphase.php' border=2></td>";
enterpriseCntnt +="<td><strong><a href='/docs/TSPG/MCD/NPI/Reports/TimeLine.php'>Cycle time</a> - sum of the pieces</strong><br><iframe src='/docs/TSPG/MCD/dashboard/img/CT.php'></iframe></td>";
enterpriseCntnt += "</tr>"; 
enterpriseCntnt += "</table>";
enterpriseCntnt +=  " <table class='table table-bordered allContentTable' id='allEnterpriseContentTable'>";
enterpriseCntnt += "<tr>";
enterpriseCntnt +="<td><a href='/pv/reports/OverBooked.php'><b>Resource Overbooked Report</b></a></td>";
enterpriseCntnt += "</tr>"; 
enterpriseCntnt += "</table>";
enterpriseCntnt +="<div id='bubbleChartModalContainer' style='width: 970px; height: 350px;'></div>"
//enterpriseCntnt +="<div id='bubbleChartModalContainer' ></div>"
 $("#enterprisetableContainer").append(enterpriseCntnt);
 
    createBubbleChartModal();
}
