...
class CreateDashboardExcel {
    ...
    function getDashboardExcel() {
        ...
        $excelFinancialHeaderArr = $GLOBALS['excelFinancialHeaderArr'];
        $prettyFinancialHeaderArr = array_keys($excelFinancialHeaderArr);
        ...
        foreach ($allRowData as $oneRow){
            ...
            foreach ($excelFinancialHeaderArr as $oneColKey){
