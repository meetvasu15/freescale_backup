...
function GetFinancialView(index){
  ...
  //  alert (financialsJson.Die_Size.cellValue);
    ...
    modalHtml +="<tr><td>Total Revenue</td><td>"+financialsJson.Total_Revenue_Tgt+"</td><td class='"+financialsJson.Total_Revenue.cellColor+"'>"+financialsJson.Total_Revenue.cellValue+"</td>";
    modalHtml +="</table>";
    modalHtml +="</div>"; 
